...
g = GeneticAlgo(hash_map=dist_dict,start='Grenoble',mutation_prob=0.25,crossover_prob=0.25,
				 population_size=5,steps=15,iterations=2000)
g.converge()
import math
print("nombre de routes possibles : ", math.factorial(20))